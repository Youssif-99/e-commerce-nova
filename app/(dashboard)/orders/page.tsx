              ...
              <table className="min-w-full text-left text-xs">
                ...
                <tbody className="divide-y [border-color:var(--border)]">
                  {orders.map((order) => (
                    ...
                    >
                      <td className="py-2 pr-3 text-[11px] font-medium [color:var(--muted-strong)]">
                        {order.id}
                      </td>
                      <td className="px-3 py-2">
                        <div>
                          <p className="text-[11px] [color:var(--muted-strong)]">{order.customer}</p>
                          <p className="text-[10px] [color:var(--muted)]">{order.email}</p>
                        </div>
                      </td>
